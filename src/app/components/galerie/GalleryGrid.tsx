...
import type { GalleryImageDoc } from "@/lib/firebase/gallery";

type GalleryImageForDisplay = Omit<GalleryImageDoc, "createdAt"> & {
  createdAt?: string | null;
};

export function GalleryGrid({ images }: { images: GalleryImageForDisplay[] }) {
  const [selected, setSelected] = useState<GalleryImageForDisplay | null>(null);
